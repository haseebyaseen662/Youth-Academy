    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide__category -->
                <li class="slide__category"><span class="category-name">Institue</span></li>
                <!-- End::slide__category -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Institute</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide has-sub">
                            <a href="{{ route('institute.add') }}" class="side-menu__item">Add Institute</a>
                        </li>
                        <li class="slide">
                            <a href="{{ route('institute.list') }}" class="side-menu__item">Institute List</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <!-- Start::slide__category -->
                <li class="slide__category"><span class="category-name">Frontend</span></li>
                <!-- End::slide__category -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Frontend</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide has-sub">
                            <a href="#" class="side-menu__item">Setting</a>
                        </li>
                        <li class="slide">
                            <a href="#" class="side-menu__item">Pages</a>
                        </li>
                        <li class="slide">
                            <a href="#" class="side-menu__item">Gallery Categories</a>
                        </li>
                        <li class="slide">
                            <a href="#" class="side-menu__item">Gallery Items</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <!-- Start::slide__category -->
                <li class="slide__category"><span class="category-name">Admission</span></li>
                <!-- End::slide__category -->
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="#" class="side-menu__item">Admission Category</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <!-- Start::slide__category -->
                <li class="slide__category"><span class="category-name">Students</span></li>
                <!-- End::slide__category -->
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="#" class="side-menu__item">Add Department</a>
                        </li>
                        <li class="slide">
                            <a href="#" class="side-menu__item">Add Designation</a>
                        </li>
                        <li class="slide">
