...
<head>
    ...
    <meta name="Description" content="Youth Academy - Empowering Generations Through Learning.">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="index.html" class="header-logo">
                                <img src="{{ asset('admin/assets/images/brand-logos/desktop-logo.png') }}"
                                    alt="logo" class="desktop-logo">
                                <img src="{{ asset('admin/assets/images/brand-logos/toggle-logo.png') }}"
                                    alt="logo" class="toggle-logo">
                                <img src="{{ asset('admin/assets/images/brand-logos/desktop-white.png') }}"
                                    alt="logo" class="desktop-white">
                                <img src="{{ asset('admin/assets/images/brand-logos/toggle-white.png') }}"
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element headerProfile-dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                            ...
                            <img src="{{ asset('admin/assets/images/faces/6.jpg') }}" alt="img" width="37"
                    ...
                    <div class="header-element">
                        ...
                        <a href="javascript:void(0);" class="header-link switcher-icon" data-bs-toggle="offcanvas"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" width="24"
